...
import com.example.Desafio_anota_ai.services.ProductService;
...
public class ProductController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Product> delete(@PathParam("id") String id, @RequestBody ProductDTO productData) {
